...
## the model is highly significant as chi-squared value is 1472.1 for degree of freedoms = 41 and p-value is 0.
...
# mou_Range             0.000257280
# change_mou           -0.690554779
# drop_blk_Mean         0.007039829
# drop_vce_Range        0.019471784 
# mou_opkv_Range       -0.000931999 
# iwylis_vce_Mean      -0.018853764
# adjmou                0.000019529
# retdays_1             0.640185893
# complete_vce_Mean    -0.001973915
...
#       there is increase in log odds of Churn versus non-churn by 0.000257280 units.
# var change_mou i.e. with a unit increase in 'Percentage change in monthly minutes of 
#     use vs previous three month average, there is decrease in log odds of Churn versus non-Churn by -0.690554779 units.
# var drop_blk_Mean i.e. with unit increase in 'Mean number of dropped or blocked calls', 
#     there is an increase in log odds of churn versus non-churn by 0.007039829 units.
# var drop_vce_Range i.e. with a unit increase in 'Range of number of dropped (failed) voice calls', 
#     there is an increase in log odds of churn versus non-Churn by 0.019471784 units.
# var mou_opkv_Range  i.e. with a unit increase in  'Range of unrounded minutes of use of 
#     off-peak voice calls, there is a decrease in log odds of churn versus non-Churn by -0.000931999 units.
# var iwylis_vce_Mean i.e. with a unit increase in 'Mean number of inbound wireless to wireless voice calls',
#     there is a decrease in log odds of churn versus non-churn by -0.018853764 units.
# var adjmou i.e. with unit increase in  'Billing adjusted total minutes of use over the life of the customer',
#     there is an increase in log odds of churn versus non-Churn by 0.000019529 units.
# var retdays_1 representing values captured in the variable retdays i.e. with a unit increase in 
#     'Number of days since last retention call', there is an increase in log odds of churn versus non-Churn by 0.640185893 units.

###     This variable is probably explaining the service quality of the company.


# var complete_vce_Mean i.e. with unit increase in 'Mean number of completed voice calls' 
#     there is a decrease in log odds of churn versus non-Churn by -0.001973915 units.
...
# their grieviances are not being catered properly. These customers should be paid more attention to and 
...
#   In this case it seems customers are not really using the internet as almost all the variables related to data calls and data usage have come insignificant.
